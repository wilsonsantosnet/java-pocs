...
public class AuthHelper {
    ...
    public static void acquireTokenSilently(IdentityContextAdapter contextAdapter, String newScope)
            throws AuthException {
                ...
                final SilentParameters parameters = SilentParameters.builder(Collections.singleton(newScope), context.getAccount())
                    .build();
    ...
    public static void acquireTokenSilently(IdentityContextAdapter contextAdapter)
            throws AuthException {
                ...
                acquireTokenSilently(contextAdapter,Config.SCOPES);
    }
